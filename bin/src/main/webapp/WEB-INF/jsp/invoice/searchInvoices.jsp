...
<a href="${pageContext.request.contextPath}/invoice/edit?id=${searchTable.id}"><img src="../resources/images/edit_green.png" title="Edit" />
</a>
<a href="${pageContext.request.contextPath}/invoice/view?id=${searchTable.id}&flow=searchInvoices"><img src="../resources/images/view_green.png" title="View" />
</a>
<a href="${pageContext.request.contextPath}/invoice/print?invoiceId=${searchTable.id}" target="_blank"><img src="../resources/images/printer_green.png" title="Print" />
</a>
<img src='../resources/images/delete_green.png' onclick='javascript:authoriseUser("${pageContext.request.contextPath}/invoice/delete?id=${searchTable.id}")' />
<a href="${pageContext.request.contextPath}/invoice/displayEditNote?id=${searchTable.id}" target="_blank"><img src="../resources/images/note_green.png" title="Add note" /></a>
  </display:column>
  					</display:table>
</c:if>		
