...
<div class="rows">
      <div class="row">
          <div class="column w-100-percent">
          	Edit Supplier order line for stock : <label>${supplierOrderLine.stockItem.title}</label>
          </div>
       </div>
</div>
		<form:form modelAttribute="supplierOrderLine" action="${pageContext.request.contextPath}/supplierOrderLine/edit?flow=${flow}" method="post">
			<form:hidden path="id"/>
...
<div class="rows">
      <div class="row">
          <div class="column w-33-percent">
	           ...
	           <form:input type="number" min="0" path="amount" required="required" autofocus="autofocus"/> <form:errors path="amount" />                  
	 	 </div>
          <div class="column w-33-percent">
      ...
      <div class="row">
		  <div class="column w-100-percent">
		  	<input type="submit" class="btn btn-primary" id="createSupplierOrderSubmitButton" value="Update"/>
