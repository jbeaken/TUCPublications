...
@Controller
@RequestMapping("/bounciesMerchandise")
public class BounciesMerchandiseController extends AbstractStickyController {
	...
	public String manage(HttpSession session, ModelMap modelMap) {
		...
		Collection<StockItem> stockItems = stockItemService.getMerchandise();
