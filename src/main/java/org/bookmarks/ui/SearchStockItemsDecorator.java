...
public class SearchStockItemsDecorator extends AbstractBookmarksTableDecorator {
	...
	public String getPriceForMarxism() {
		...
		if(stockItem.getQuantityForMarxism() != null) {
			...
			return numberStyleFormatter.print(priceForMarxism, Locale.UK);
		}
		return "0";
	}
	...
	protected String getPrices(StockItem stockItem) {
		return numberStyleFormatter.print(stockItem.getSellPrice(), Locale.UK) + "/" +
			numberStyleFormatter.print(stockItem.getPublisherPrice(), Locale.UK) + "/" +
			numberStyleFormatter.print(stockItem.getCostPrice(), Locale.UK);
	}
