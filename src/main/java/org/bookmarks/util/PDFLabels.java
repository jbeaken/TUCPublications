 ...
 *   iText required, visit:  <a href="http://www.itextpdf.com/iText/">iText Website </a>
 *
 */
...
public class PDFLabels {
    ...
    /** Custom label dimensions - in inches.
        Creates a new instance of PDFLabels.
     */
    public PDFLabels(float H, float W, float LRM, float TBM, float GAP, OutputStream os) {
...
//                writer = PdfWriter.getInstance(document, new FileOutputStream(PDF));
            ...
            ct.setSimpleColumn(0, TBM, PageSize.LETTER.getWidth(), PageSize.LETTER.getHeight() - TBM*2, 0, Element.ALIGN_MIDDLE);

            ACROSS = ( PageSize.LETTER.getWidth() - (LRM * 2) ) / W;  //how many labels across based on supplied dims
            ACROSS -= ACROSS % 1; // trim the fat

            DOWN = ( PageSize.LETTER.getHeight() - (TBM * 2) ) / H; //how many labels up/down based on supplied dims
    ...
    /** Takes a regular label and slaps a UK postal image at the bottom.
        If you provide a crap code it will skip the barcode
     * @throws IOException 
     * @throws MalformedURLException 
     * @throws BadElementException 
     */
    public void appendPostage (String label) throws BadElementException, MalformedURLException, IOException{
    	...
    	t.addCell(cell);
		 ...
		 //Image
    	Image img = Image.getInstance("/home/svn/terapin/src/main/webapp/images/postage/ppi_eng_first_14x54.jpg");
//        Image img = Image.getInstance("/home/svn/terapin/src/main/webapp/images/list.png");
        img.scalePercent(10);
		    	
        PdfPCell imageCell = new PdfPCell(img);
//        imageCell.setFixedHeight(H * .15f);
		//cell.setVerticalAlignment(Element.ALIGN_TOP);
		this.formatCell(imageCell);
...
//        }
    ...
    protected Font DOC_FONT = new Font (Font.FontFamily.COURIER, 10, Font.NORMAL);
