...
<form:form modelAttribute="stockItem" action="/bouncies/addSticky" method="post">
	<div class="rows">
	        <div class="row">
	      ...
	      <div class="row">
	          <div class="column w-33-percent">
	 				...
	 				<a class="btn btn-danger" href="/bouncies/save">Save Bouncies</a>
		 	 </div>		 	 
		</div>		
	</div>		
</form:form>
			   ...
			   id="searchTable">		
					  ...
					  <display:column title="Actions" media="html">
						  ...
						  <ul class="dropdown-menu" role="menu">
						    <li><a href="/bouncies/moveUp?index=${searchTable_rowNum - 1}">Move Up</a></li>
						    <li><a href="/bouncies/moveDown?index=${searchTable_rowNum - 1}">Move Down</a></li>
						    <li><a href="/bouncies/remove?index=${searchTable_rowNum - 1}">Remove</a></li>
						    <li class="divider"></li>						   
