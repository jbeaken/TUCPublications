...
<div id="rows">
  <div class="row">
          <div class="column w-100-percent"> 
      	  ...
      	  <button type="button" class="btn btn-warning" id="reorderReviewButton" onclick="javascript:submitForm('${pageContext.request.contextPath}/stock/search?reorderReview=true')">Reorder Review</button>&nbsp;
