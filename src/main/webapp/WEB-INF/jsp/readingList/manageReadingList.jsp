...
<form:form modelAttribute="stockItem" action="/readingList/addSticky" method="post">
	<div class="rows">
	        <div class="row">
	      ...
	      <div class="row">
	          <div class="column w-33-percent">
	 				...
	 				<a class="btn btn-danger" href="/readingList/save">Save Reading List</a>
		 	 </div>
		</div>
	</div>
</form:form>
			   ...
			   id="searchTable">
					  ...
					  <display:column title="Actions" media="html">
						  ...
						  <ul class="dropdown-menu" role="menu">
						    <li><a href="/readingList/moveUp?index=${searchTable_rowNum - 1}">Move Up</a></li>
						    <li><a href="/readingList/moveDown?index=${searchTable_rowNum - 1}">Move Down</a></li>
						    <li><a href="/readingList/remove?index=${searchTable_rowNum - 1}">Remove</a></li>
						    <li class="divider"></li>
						    <li><a href="/stock/edit?id=${searchTable.id}&flow=readingList"  target="_blank">Edit Stock</a></li>
						  </ul>
						</div>
					  </display:column>
  		</display:table>
